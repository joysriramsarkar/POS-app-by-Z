  ...
  const handleTestHtml5Qrcode = async () => {
    ...
    try {
      ...
      try {
        ...
        appendLog(`Stack: ${(error instanceof Error ? error.stack : String(error))}`);
      }
    } finally {
      setIsRunning(false);
    }
      ...
      <div className="max-w-4xl mx-auto">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Run diagnostic tests to identify camera and barcode scanning issues
            </CardDescription>
          </CardHeader>
            ...
            <Alert className="bg-yellow-50 border-yellow-200">
              <AlertDescription>
                ...
                <ul className="mt-2 ml-4 space-y-1 list-disc">
                  <li>Click "Test Camera Access" to verify your device has camera and permissions</li>
                  <li>Click "Test Html5-QRCode" to test the barcode scanner library directly</li>
                  <li>Watch the console output for detailed error messages</li>
                  <li>Check browser DevTools (F12 → Console) for additional logs</li>
                </ul>
              </AlertDescription>
            </Alert>
          </CardContent>
