  ...
  const handleTestCameraAccess = async () => {
    ...
    try {
      ...
      try {
        ...
        appendLog(`❌ Error enumerating devices: ${(error instanceof Error ? error.message : "Unknown error")}`);
      }
      ...
      try {
        ...
        appendLog(`❌ Back camera failed: ${(error instanceof Error ? error.message : "Unknown error")}`);
      }
      ...
      try {
        ...
        appendLog(`❌ Front camera failed: ${(error instanceof Error ? error.message : "Unknown error")}`);
      }
      ...
      try {
        ...
        appendLog(`❌ Raw video test failed: ${(error instanceof Error ? error.message : "Unknown error")}`);
      }
  ...
  const handleTestHtml5Qrcode = async () => {
    ...
    try {
      ...
      try {
        ...
        appendLog(`❌ Failed to import/use html5-qrcode: ${(error instanceof Error ? error.message : "Unknown error")}`);
