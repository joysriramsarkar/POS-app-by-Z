  ...
  const handleTestCameraAccess = async () => {
    ...
    try {
      ...
      try {
        ...
        appendLog(`❌ Error enumerating devices: ${errorMessage}`);
      }
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : String(error);
        appendLog(`❌ Back camera failed: ${errorMessage}`);
      }
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : String(error);
        appendLog(`❌ Front camera failed: ${errorMessage}`);
      }
      ...
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : String(error);
        appendLog(`❌ Raw video test failed: ${errorMessage}`);
      }
  ...
  const handleTestHtml5Qrcode = async () => {
    ...
    try {
      ...
      try {
        ...
        appendLog(`❌ Failed to import/use html5-qrcode: ${errorMessage}`);
