  ...
  const handleTestCameraAccess = async () => {
    ...
    try {
      ...
      try {
        ...
        appendLog(`❌ Error enumerating devices: ${message}`);
      }
      ...
      try {
        ...
        const message = error instanceof Error ? error.message : String(error);
        appendLog(`❌ Back camera failed: ${message}`);
      }
      ...
      try {
        ...
        const message = error instanceof Error ? error.message : String(error);
        appendLog(`❌ Front camera failed: ${message}`);
      }
      ...
      try {
        ...
        const message = error instanceof Error ? error.message : String(error);
        appendLog(`❌ Raw video test failed: ${message}`);
      }
  ...
  const handleTestHtml5Qrcode = async () => {
    ...
    try {
      ...
      try {
        ...
        const message = error instanceof Error ? error.message : String(error);
        appendLog(`❌ Failed to import/use html5-qrcode: ${message}`);
